...
- API 数据同步及本地缓存兜底
- 手机底部导航与 Pad 侧边导航
- 每篇文章独立倒计时：支持自定义分钟数、暂停、重新计时和提醒风格；当前提供高达风机甲拔刀动画与英语语音，以及带原声的 14 秒“银河警报”视频提醒
- 阅读排版、限时开关、分钟数和提醒风格会在 Web、iOS 与 Android 本地自动记住；新文章优先使用最近一次阅读偏好，单篇已经保存的设置保持不变
- 没有保存过限时偏好时，新文章首次打开的默认限时不少于 8 分钟，仍可在阅读设置中自定义为 1-180 分钟
